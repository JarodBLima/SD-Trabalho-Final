...
class Config:
    ...
    SSL_CERT_PATH = os.path.join(os.path.dirname(__file__), 'certificados/cliente.crt')
    SSL_KEY_PATH = os.path.join(os.path.dirname(__file__), 'certificados/cliente.key')